...
c.attr("shr_form_factor");c.addClass(e+"-head");c.attr("data-shr_link")||c.attr("shr_link");c.attr("data-shr_title")||c.attr("shr_title");c.attr("data-shr_short_link")||c.attr("shr_short_link");c.children("#shareaholic-services").wrapInner("<ul></ul>");b(e,c)})};var b=function(c,b){SHR4P.debug("SHR4P.TB.layoutFormFactor called");if(!(typeof c=="undefined"||!c||typeof b=="undefined"||!b)&&c=="shareaholic-top-bar"&&!d){var d=!0,f=SHRTB_Settings.topBarBgColor,i=SHRTB_Settings.topBarBorderColor,d=!1,
...
a("<div id='shareToolBarContainer'></div>"),i=a("<div id='shareToolBarFooter'></div>"),d=a("<div id='shareaholic-bar' class='shareToolBarShadow' style='display:none'></div>"),l=a("<div id='shareToolBar'></div>");b.wrap(l);l=b.parents("#shareToolBar");l.wrap(g);g=l.parents("#shareToolBarContainer");g.wrap(d);d=g.parents("#shareaholic-bar");f.prependTo(d);i.appendTo(d);f=b.parents("#shareaholic-bar");SHR4P.debug(f);a('<div id="showHideToolBar" title="Click to hide"><div class="shareToolBarButton shareToolBarHideButton"></div></div>').appendTo(g);
a('<div id="shareToolBarAddv"></div>').appendTo(g);var n=a("#shareaholic-bar"),h=a("#showHideToolBar");h.click(function(){j=!j;a("#showHideToolBar > div").toggleClass("shareToolBarShowButton shareToolBarHideButton");j?(h.hide(),a("#shareaholic-bar").css("border-bottom-width","0px").removeClass("shareToolBarShadow")):h.css("margin-left","-100%");a("#shareToolBar, #shareToolBarAddv").slideToggle("slow",function(){j||(a("#shareaholic-bar").css("border-bottom-width","1px").addClass("shareToolBarShadow"),
a("#shareToolBarHeader").animate({height:"+=5"},{duration:100}).animate({height:"-=5"},{duration:100}),h.attr("title","Click to hide"));var b=a("#showHideToolBar").css("margin-left");j&&b!="0px"&&(h.css("margin-left","0"),h.fadeIn("slow"),h.attr("title","Click to display"))})});a(window).scroll(function(){var b=a(window).scrollTop(),c=n.css("display")=="none";SHR4P.debug("ScrollTop "+b+" ScrollOffset: "+k);b>k?c&&a("#shareaholic-bar,#shareToolBar, #shareToolBarAddv").slideDown("slow",function(){a("#shareToolBarHeader").animate({height:"+=5"},
{duration:100}).animate({height:"-=5"},{duration:100});a("#shareaholic-bar").css("border-bottom-width","1px").addClass("shareToolBarShadow");h.fadeIn("slow");h.attr("title","Click to hide")}):j||(h.hide(),a("#shareaholic-bar").css("border-bottom-width","0px").removeClass("shareToolBarShadow"),a("#shareaholic-bar,#shareToolBar, #shareToolBarAddv, #showHideToolBar").slideUp("slow"))})}}}(SHR4P.TB.jQuery),SHR4P.TB.ready=!0,typeof SHR4P.TB.onready!="undefined")SHR4P.TB.onready()};
...
".shareaholic-like-buttonset").each(function(){var a=SHR4P.TB.jQuery(this);if((a.attr("data-shr_status")||!1)!="1"){var b=a.attr("data-shr_href")||a.attr("shr_href"),c=a.attr("data-shr_title")||a.attr("shr_title"),e=a.attr("data-shr_size")||a.attr("shr_size"),d=a.attr("data-shr_count")||a.attr("shr_count"),f=a.attr("data-shr_annotation"),i=a.attr("data-shr_width"),k=a.attr("data-shr_expandto"),j=a.attr("data-shr_onstartinteraction"),g=a.attr("data-shr_onendinteraction");if(typeof d=="undefined"||
!d)d="true";if((typeof b=="undefined"||!b)&&(typeof c=="undefined"||!c))b=encodeURIComponent(document.location.href),c=document.title;else{if(typeof b=="undefined"||!b)b=encodeURIComponent(document.location.href);if(typeof c=="undefined"||!c)c=""}if(typeof e=="undefined"||!e)e="standard";if(typeof f=="undefined"||!f)f="bubble",f=typeof d!=="undefined"&&d&&d!=="false"?"bubble":"none";if(typeof i=="undefined"||!i)i="450px";if(typeof k=="undefined"||!k)k="";if(typeof j=="undefined"||!j)j="";if(typeof g==
"undefined"||!g)g="";d="";e=="medium"&&(d="padding-top:1px !important;");a.attr("data-shr_status","1");d=SHR4P.TB.jQuery("<div style='float:left; "+d+" margin:0px 0px 0px 10px !important;'/>").get(0);a.replaceWith(d);SHR4P.TB.jQuery(d).append("<div/>");d=SHR4P.TB.jQuery(d).find(":first-child").get(0);gapi.plusone.render(d,{size:e,annotation:f,width:i,expandto:k,onstartinteraction:j,onendinteraction:g,href:decodeURIComponent(b),callback:function(a){SHR4P.TB.googPlusOneUtil.trackPlusOneClick(a,c)}})}})},
...
SHR4P.TB.twitterUtil={addTwitterScript:function(){SHR4P.TB.twitterUtil.renderShareaholicTweetButton()},renderShareaholicTweetButton:function(){SHR4P.TB.jQuery(".shareaholic-tweetbutton",".shareaholic-like-buttonset").each(function(){var a=SHR4P.TB.jQuery,b=a(this);if((b.attr("data-shr_status")||!1)!="1"){var c=b.attr("data-shr_href")||b.attr("shr_href"),e=b.attr("data-shr_title")||b.attr("shr_title"),d=b.attr("data-shr_size")||b.attr("shr_size"),f=b.attr("data-shr_count")||b.attr("shr_count"),i=b.attr("data-shr_lang"),
k="shr-7",j="shr-generic",g=!0,l=!0;SHR4P.debug(b);if(typeof f=="undefined"||!f)f="horizontal";if((typeof c=="undefined"||!c)&&(typeof e=="undefined"||!e))c=encodeURIComponent(document.location.href),e=document.title;else{if(typeof c=="undefined"||!c)c=encodeURIComponent(document.location.href);if(typeof e=="undefined"||!e)e=""}if(typeof d=="undefined"||!d)d="standard";var n="";d=="medium"&&(n="padding-top:1px !important;");if(typeof i=="undefined"||!i)i="en";switch(f){case "horizontal":l=g=!0;break;
case "vertical":g=!0;l=!1;break;case "none":l=g=!1}g&&(k+="-count",j+="-count");g&&l&&(k+="-compact",j+="-compact");if(g&&typeof SHRSB_Globals!="undefined"&&SHRSB_Globals.perfoption=="1"){var h=this;if(l){this.style.marginRight="0px";var m=document.createElement("div"),h=document.createElement("div"),d=this.parentNode;d.appendChild(h);h.className="shr_compact_div";m.className="shr_compact_tick";m.appendChild(document.createElement("s"));m.appendChild(document.createElement("i"));d.insertBefore(m,
h)}g&&SHR4P.TB.utils.getTwitShrCnt(decodeURIComponent(c),function(b){b.count==0?(a(h).hide(),a(m).hide()):h.innerHTML=b.count})}var o={title:e,link:c,short_link:c,shortener:SHRSB_Globals.shortener?SHRSB_Globals.shortener:"google",shortener_key:SHRSB_Globals.shortener_key?SHRSB_Globals.shortener_key:"",v:1,apitype:1,apikey:SHR4P.TB.shr_apiKey,twitter_template:SHR4P.TB.shr_twitter_template?SHR4P.TB.shr_twitter_template:"${title} - ${short_link}",service:7};[SHR4P.TB.shr_link,a.param(o)].join("?");a(this).before(a('<style type="text/css"> div.shareaholic a{background-image:url('+
...
"</style>"));b.wrap('<div class="shr-7 shareaholic" style="float:left; '+n+' margin:0px 0px 0px 10px !important;"></div>');b.parent().removeClass("shr-7");b.addClass(j);b.addClass(k);SHR4P.debug(b);SHR4P.TB.utils.isMobileBrowser()||b.click(function(a){SHR4P.TB.utils.showServiceLet(o,"twitter");a.preventDefault()});b.attr("data-shr_status","1")}})},trackTweetButtonClick:function(a){a.type="tweet";SHR4P.TB.jQuery("<img/>").attr({src:"http://www.shareaholic.com/api/share/?v=1&apikey="+SHR4P.TB.shr_apiKey+
...
var e=a.attr("data-shr_showfaces");if(typeof e=="undefined"||!e)e="true";var d=a.attr("data-shr_send");if(typeof d=="undefined"||!d)d="false";var f=a.attr("data-shr_action");if(typeof f=="undefined"||!f||f.toLowerCase()!="recommend"&&f.toLowerCase()!="like")f="like";var i=SHR4P.TB.jQuery("<div style='float:left;padding-top:0px !important; margin:0px 5px !important;'/>").get(0);a.replaceWith(i);if(SHR4P.TB.fbUtil.hasFBNameSpace())b=SHR4P.TB.jQuery('<fb:like action="'+f+'" send = "'+d+'" href="'+b+
'"layout="'+c+'" show_faces="'+e+'" width="60" font=""></fb:like>').appendTo(i),typeof window.FB!="undefined"&&FB.XFBML&&FB.XFBML.parse&&FB.XFBML.parse(b.get(0));else{a="30";d="60";switch(c){case "button_count":d="90";a="21";break;case "box_count":d="60";a="90";break;default:d="60",a="80"}SHR4P.TB.jQuery('<iframe src="http://www.facebook.com/plugins/like.php?app_id=207766518608&amp;href='+b+"&amp;send=false&amp;layout="+c+"&amp;width="+d+"&amp;show_faces="+e+"&amp;action="+f+"&amp;colorscheme=light&amp;font&amp;height="+
a+'" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:'+d+"px; height:"+a+'px;" allowTransparency="true"></iframe>').appendTo(i)}})},addFBConnect:function(){SHR4P.TB.fbUtil.addFBNameSpace();if(!SHR4P.TB.fbUtil.fbConnectAdd)SHR4P.TB.jQuery('<div id="fb-root"></div>').appendTo("body"),window.fbAsyncInit=function(){FB.init({appId:"207766518608",status:!0,cookie:!0,xfbml:!0});SHR4P.TB.fbUtil.tryAddFBSubscription()},SHR4P.TB.fbUtil.renderFBWidgetHandlerAttached=!0,function(){var a=
