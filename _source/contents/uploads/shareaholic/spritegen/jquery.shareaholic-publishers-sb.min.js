...
"undefined"?SHR4P.locales[e][SHR4P.tooltips_prefix_map[c]]+" "+SHR4P.tooltips_suffix[c]:"";SHR4P.ga.socialAction({serviceId:c,serviceAction:"render",link:a.link});var k=b("<li/>");k.addClass("shr-"+c).addClass("shareaholic").attr("style","margin-left:"+a.li_margin+"px !important;").bind("click",{serviceId:c,serviceAction:"share",link:a.link},SHR4P.ga.trackAction);var p={title:a.title,link:a.link,notes:a.notes,short_link:a.short_link,shortener:a.shortener,shortener_key:a.shortener_key,v:a.api.share.v,
apitype:a.api.share.apitype,apikey:a.apikey,source:a.api.share.source,template:h,service:c,ctype:a.ctype};c=="7"&&a.twitter_overlay&&!SHR4P.utils.isMobileBrowser()?k.append(b("<a/>").attr({rel:a.rel,target:a.target,"class":"external"}).attr(i,e).text(e).click(function(b){SHR4P.utils.showServiceLet(a,"twitter");b.preventDefault()})).appendTo(j):k.append(b("<a/>").attr({href:f(a.share_src+a.api.share.url,p),rel:a.rel,target:a.target,"class":"external"}).attr(i,e).text(e)).appendTo(j);c=="309"&&k.click(function(a){SHR4P.utils.runBookmarklet(p);
...
h="shr-7",j="shr-generic",i=!0,k=!0;SHR4P.debug(c);if(typeof e=="undefined"||!e)e="horizontal";if((typeof d=="undefined"||!d)&&(typeof a=="undefined"||!a))d=encodeURIComponent(document.location.href),a=document.title;else{if(typeof d=="undefined"||!d)d=encodeURIComponent(document.location.href);if(typeof a=="undefined"||!a)a=""}if(typeof f=="undefined"||!f)f="standard";var o="";f=="medium"&&(o="padding-top:1px !important;");if(typeof g=="undefined"||!g)g="en";switch(e){case "horizontal":k=i=!0;break;
case "vertical":i=!0;k=!1;break;case "none":k=i=!1}i&&(h+="-count",j+="-count");i&&k&&(h+="-compact",j+="-compact");if(i&&typeof SHRSB_Globals!="undefined"&&SHRSB_Globals.perfoption=="1"){var l=this;if(k){this.style.marginRight="0px";var m=document.createElement("div"),l=document.createElement("div");b(this).after(l);l.className="shr_compact_div";m.className="shr_compact_tick";m.appendChild(document.createElement("s"));m.appendChild(document.createElement("i"));b(this).after(m)}i&&SHR4P.utils.getTwitShrCnt(decodeURIComponent(d),
function(a){a.count==0?(b(l).hide(),b(m).hide()):l.innerHTML=a.count})}var n=d,q={title:a,link:n,short_link:"",shortener:SHRSB_Globals.shortener?SHRSB_Globals.shortener:"google",shortener_key:SHRSB_Globals.shortener_key?SHRSB_Globals.shortener_key:"",v:1,apitype:1,apikey:SHR4P.shr_apiKey,twitter_template:SHR4P.shr_twitter_template?SHR4P.shr_twitter_template:"${title} - ${short_link}",service:7},d=b(this),a=SHR4P.shr_image||SHR4P.shr_twitter_image,f=SHR4P.shr_image?".shr-7-count{background-position:-57px -80px;}.shr-7-count-compact,.shr-7{height:14px;width:55px;background-position:-228px -79px;}.shr-7-count-compact:hover,.shr-7:hover{height:14px;width:55px;background-position:-228px -100px;}.shr-7-count-compact:active,.shr-7:active{height:14px;width:55px;background-position:-228px -121px;}":
...
f+"</style>"));c.wrap('<div class="shr-7 shareaholic" style="float:left; '+o+' margin:0px 0px 0px 10px !important;"></div>');c.parent().removeClass("shr-7");c.addClass(j);c.addClass(h);SHR4P.debug(c);SHR4P.ga.socialAction({serviceId:7,serviceAction:"render",link:n});SHR4P.utils.isMobileBrowser()||c.click(function(a){SHR4P.ga.socialAction({serviceId:7,serviceAction:"share",link:n});SHR4P.utils.showServiceLet(q,"twitter");a.preventDefault()});c.attr("data-shr_status","1")}})}};
